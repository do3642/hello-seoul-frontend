...
function NaverMap({ map, geoJson, showCurrentLocation, activeButton, handleButtonClick, setResetFeature }) {
  ...
  useEffect(() => {
    if (map && geoJson) {
      ...
      const { resetSelectedFeature } = MapHover(map, geoJson, activeButton, handleButtonClick, groupedSpots);
